...
static long value(lenVal *x);
static void initLenVal(lenVal *x, long value);
static short EqualLenVal(lenVal *expected, lenVal *actual, lenVal *mask);
static void addVal(lenVal *resVal, lenVal *val1, lenVal *val2);
static short RetBit(lenVal *lv, int byte, int bit);
static void SetBit(lenVal *lv, int byte, int bit, short val);
static void  readVal(lenVal *x, short numBytes);
...
*****************************************************************************/
static long value( lenVal*     plvValue )
{
...
* Returns:      void.
*****************************************************************************/
static void initLenVal( lenVal*    plv,
                 long       lValue )
{
    plv->len    = 1;
...
*****************************************************************************/
static short EqualLenVal( lenVal*  plvTdoExpected,
                   lenVal*  plvTdoCaptured,
                   lenVal*  plvTdoMask )
{
    short           sEqual;
...
*****************************************************************************/
static short RetBit( lenVal*   plv,
              int       iByte,
              int       iBit )
{
...
* Returns:      void.
*****************************************************************************/
static void addVal( lenVal*    plvResVal,
             lenVal*    plvVal1,
             lenVal*    plvVal2 )
{
...
* Returns:      void.
*****************************************************************************/
static void readVal( lenVal*   plv,
              short     sNumBytes )
{
